...
%	\caption{Decision Tree for Activity Detection.}
%	\label{fig-activity}
%\end{figure}
...
%
%seMatch in \cite{aly2015semmatch} provides a HMM-based outdoor map matching for challenging positioning traces.
%
...
%
%We view indoor maps generated by SLAM algorithms as input to our proposed map matching algorithm.
%
%\subsection{Wall Constrainted Localization}
%
%
