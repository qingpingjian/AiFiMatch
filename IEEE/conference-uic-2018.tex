...
\begin{equation}
{f_2}({\rm{z}}.{\rm{dist}}({\rm{t}}),{{\rm{s}}_{\rm{i}}}.{\rm{dist}}) = \frac{{{e^{ - 4.5}}}}{{\sqrt {2\pi } {\sigma _d}}},z.dist(t) + 3{\sigma _d} \le {s_i}.dist
\end{equation}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=3.35in]{AiFiMatch-OnlinePosition}
