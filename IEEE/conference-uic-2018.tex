...
\begin{figure}[!ht]
	\vspace{-10pt}
	\centering
	\subfloat[$Decision\ Tree\ for\ Activity\ Detection.$]{\includegraphics[width=3.15in]{AiFiMatch-ActivityDecision}%
		\label{fig-activity}}
	\vfil
	\subfloat[$Activity\ Detected\ Example.$]{\includegraphics[width=2.875in]{AiFiMatch-TurnDemo}%
		\label{fig-turndemo}}
